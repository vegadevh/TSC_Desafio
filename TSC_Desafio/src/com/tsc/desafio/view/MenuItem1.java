...
public class MenuItem1 extends javax.swing.JPanel {
    ...
    public MenuItem1(Icon icon, String menuName, ActionListener actionListener, MenuItem1... subMenu) {
        initComponents();
    ...
    public MenuItem1(String menuName, ActionListener actionListener,MenuItem1... subMenu) {
        initComponents();
        LabelName.setText(menuName);
    ...
    public MenuItem1(Icon icon, String menuName, MenuItem1... subMenu) {
        initComponents();
        theIcon.setIcon(icon);
        LabelName.setText(menuName);
    ...
    private void initComponents() {
        ...
        theIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/tsc/desafio/resources/iconmenu/malla.png"))); // NOI18N
